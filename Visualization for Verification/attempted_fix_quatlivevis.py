...
# data structure to hold the latest quaternion value
...
# Transformation matrix to align the sensor's orientation
M = np.array([[1, 0, 0],
              [0, 1, 0],
              [0, 0, -1]])
...
class Quaternion:
    ...
    def as_rotation_matrix(self):
        ...
        original_rotation_matrix = np.array([[v[0] * v[0] * (1 - c) + c,
                                             v[0] * v[1] * (1 - c) - v[2] * s,
                                             v[0] * v[2] * (1 - c) + v[1] * s],
                                            [v[0] * v[1] * (1 - c) + v[2] * s,
                                             v[1] * v[1] * (1 - c) + c,
        ...
        return np.dot(M, original_rotation_matrix)
