...
parser.add_option("-i", dest="start", help="absolute path of file that will be used to start thid script", default = None, metavar="START")
...
if options.start is None:
    raise ValueError("No start file has been specified -i")

if options.stop is None:
    raise ValueError("No end file has been specified -s")

print("--left is {}".format(options.left))
print("--folder is {}".format(options.folder))
print("--stop is {}".format(options.stop))
