...
# Define the Quaternion class as previously provided
class Quaternion:
...
# Define the CubeAxes class as previously provided
...
# Define CubeAxesAuto class to handle automatic updates
...
# IMU setup as previously provided
# ============= IMU SETUP =============
