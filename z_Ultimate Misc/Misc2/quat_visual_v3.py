...
# Continue with the rest of the code, including the Quaternion and CubeAxes classes
class Quaternion:
...
# Define CubeAxes class and visualization
...
# Continue with the rest of the code, including the IMU setup, figure creation, and update loop
# ============= IMU SETUP =============
