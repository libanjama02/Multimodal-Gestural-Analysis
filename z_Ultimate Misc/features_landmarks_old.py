...
def extract_all_features(df):
    ...
    # Remove the original x, y, z columns for each landmark
...
if __name__ == "__main__":
    ...
    # Save to a new CSV
    df.to_csv(r"C:\Users\liban\OneDrive - King's College London\!library_placementnotes\Project\Experiments\twisthand\Landmark Features\twisthand_landmarks_gesture10.csv", index=False)
