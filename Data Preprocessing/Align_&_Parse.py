...
def nearest_neighbor_alignment(hand_landmarks_df, imu_data_df):
    ...
    """
    # converts 'Timestamp' columns to datetime objects for both imu and pose dataframes 
    ...
    # Set the 'Timestamp' columns as the indices for both dataframes for alignment
...
def extract_coordinates(landmark_str):
    ...
    This accounts for small values of Z e.g. 2.1 * 10^-7
    """
...
def parse_landmarks(aligned_df):
    ...
    # Expands the lists into 63 separate columns
    for i in range(21):  
...
#Saves to dataframe
final_df.to_csv(r"C:\Users\liban\OneDrive - King's College London\!library_placementnotes\Project\Experiments\twisthand\!testing.csv", index=False)  
